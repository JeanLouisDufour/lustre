...
fn2_list = fn_list[:3]
fn3_list = fn_list[-1:]
fn4_list = fn_list[0:1] # ADR
fn5_list = fn_list[8:9] # X4

#result = lc.chk_file('C:/Users/F074018/AppData/Local/Temp/ScadeChecker/1336/kcg_xml_filter_out.scade')

for fn in fn_list if False else ():
	print('*****************************************************')
	print(fn)
	result = lc.chk_file(fn)
	#print(result)
...
if False:
	for root, dirs, files in os.walk(r'C:\Users\F074018.SDS\Documents\scadeR16\BCS_S2'):
		for f in files:
			if f.endswith('.scade'):
